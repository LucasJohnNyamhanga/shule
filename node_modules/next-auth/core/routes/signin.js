...
async function signin(params) {
  ...
  if (provider.type === "oauth") {
    ...
    var _body$email, _ref;

    let email = body === null || body === void 0 ? void 0 : (_body$email = body.email) === null || _body$email === void 0 ? void 0 : _body$email.toLowerCase();
    if (!email) return {
      redirect: `${url}/error?error=EmailSignin`
    };
    email = email.split(",")[0].trim().replaceAll("&", "&amp;").replaceAll("<", "&lt;").replaceAll(">", "&gt;").replaceAll('"', "&quot;").replaceAll("'", "&#x27;");
    const {
      getUserByEmail
    } = adapter;
