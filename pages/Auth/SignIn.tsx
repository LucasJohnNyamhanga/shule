...
const SignIn = ({}) => {
  ...
  let signInWithGoogle = async () => {
    ...
    setLoadingState({ loading: "google" });
    //! use data to proceed
  ...
  let signInWithCredentials = async () => {
    if (formData.password != "" && formData.username != "") {
      setLoadingDisplay(true);
      setLoadingState({ loading: "credential" });
      //!use data to proceed
        ...
        <div>
          {signInAccount && (
            ...
            >
              ...
              {loadingDisplay && loadingState.loading === "credential" ? (
                <div className={`${Styles.button}`}>
                  <LoaderText sms={"Signing in, wait.."} />
                </div>
              ) : (
                <div
                  onSubmit={(e) => {
                  ...
                  className={`${Styles.button} ${Styles.noWait}`}
                >
                  Sign In
                </div>
              )}
              ...
              {loadingDisplay && loadingState.loading === "google" ? (
                <div className={`${Styles.button}`}>
                  <BsGoogle className={Styles.google} />
                  <LoaderText sms={"Signing with Google"} />
                </div>
              ) : (
                <div
                  className={`${Styles.button} ${Styles.noWait}`}
        ...
        <div>
          {signUpAccount && (
            ...
            >
              ...
              {loadingDisplay && loadingState.loading === "new" ? (
                <div className={`${Styles.button}`}>
                  <LoaderText sms={"Creating Account"} />
                </div>
              ) : (
                <div
