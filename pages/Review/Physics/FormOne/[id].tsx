...
const Index = ({ topics, thisTopicData }: InferGetStaticPropsType<typeof getStaticProps>) => {
  ...
  if (thisTopicData.review ==  null || thisTopicData.review == "undefined") {
    return <div className={Styles.notFound} >Reviews for ${thisTopicData.topicName} topic will be available soon.</div>
  }
        ...
        <div className={Styles.container}>
          ...
          <div className={Styles.innerContainer}>
                ...
                <div className={Styles.titleList}>
                  {
                    topics.map((topic: dataTopic) => (
                        <div key={topic.id}>
                            <Link passHref href={`/Review/${subjectLocatorLink}/${formLocatorLink}/${topic.id}`}>
                                <a>
            ...
            <div className={Styles.mobile}>
              <Drawer textHeader={'LIST OF TOPICS'} topic={topics} active={thisTopicData.id} link={'Review'} />
            </div>
              ...
              <div  className={Styles.modal}>
            {
                    thisTopicData.review.map((review:review) => (
                      <Modal key={review.id} name={review.name} id={review.id} subject={thisTopicData.subject.subjectName} topic={thisTopicData.topicName} form={thisTopicData.form.formName}/>
                    ))
                }
            </div>
              </div>
