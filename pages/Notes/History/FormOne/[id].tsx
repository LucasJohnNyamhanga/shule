...
const subjectLocator = "History";
const formLocator = "Form One";
const subjectLocatorLink = "History";
        ...
        <div className={Styles.container}>
          ...
          <div className={Styles.innerContainer}>
            ...
            <div className={Styles.mobile}>
              <Drawer textHeader={'LIST OF TOPICS'} topic={topics} active={thisTopicData.id} link={'Notes'} />
            </div>
              ...
              <div className={Styles.BodyContent}>
                <div className="ckContent" dangerouslySetInnerHTML={{__html: htmlServer}} />
              </div>
            </div>
          </div>
        </div>
