...
const EditNotes = ({ notesData, formsList, subjects }: InferGetServerSidePropsType<typeof getServerSideProps>) => {
      ...
      <div className={Styles.innerContainer}>
        <div className={Styles.content}>
          <div className={Styles.mainContent}>
            <CkEditor content={handleContent} dataCk={notesData.content} handleEditor={handleOnReady}/>
          </div>
          <div className={Styles.controlContent}>
            ...
            {hideShow && <SelectMiu show={true} displayLabel="Select Topic" forms={topicOptions} handlechange={handleSelectTopic} value={topicSelectValue.topicId} />}
          </div>
        </div>
        <div>
          <div onClick={handleCreateNotes} className={Styles.imageSelect}>Update Notes</div>
        </div>
      </div>
    </div>
