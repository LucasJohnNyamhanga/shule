...
const Notes = ({ forms, subjects }: InferGetServerSidePropsType<typeof getServerSideProps>) => {
      ...
      <div className={Styles.innerContainer}>
        <div className={Styles.content}>
          <div className={Styles.mainContent}>
            <CkEditor content={handleContent} dataCk={''} onReadyToStart={handleOnReady} />
          </div>
          <div className={Styles.controlContent}>
            <SelectMiu show={true} displayLabel="Select Subject" forms={subjectOptions} handlechange={handleSelectSubject} value={topicSelectValue.subjectId} />
            <SelectMiu show={true} displayLabel="Select Form" forms={formOptions} handlechange={handleSelectForm} value={topicSelectValue.formId} />
            {hideShow && <SelectMiu show={true} displayLabel="Select Topic" forms={topicOptions} handlechange={handleSelectTopic} value={''} />}
          </div>
        </div>
        <div>
          <div onClick={handleCreateNotes} className={Styles.imageSelect}>Create Notes</div>
        </div>
      </div>
    </div>
