...
const Create = ({ forms, subjects }: InferGetServerSidePropsType<typeof getServerSideProps>) => {
  ...
  return (
    ...
    <div className={Styles.innerContainer}>
        ...
        <div onClick={handleCreateTopic} className={Styles.imageSelect}>Create Topic</div>
   </div>
</div>
  )
}
