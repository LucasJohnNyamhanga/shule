...
export const getServerSideProps: GetServerSideProps = async (context) => {
  ...
  let Id = parseInt(id);
    ...
    const subjectServer = await prisma.subjectReview.findUnique({
      where: {
        id: Id,
      },
      select: {
...
const EditSubject = ({ subject, formsList }: InferGetServerSidePropsType<typeof getServerSideProps>) => {
...
//! for uploading
    ...
    let sendToDatabase = (location: string) => {
        ...
        axios({
            method: 'post',
            url: 'http://localhost:3000/api/updateSubjectReview',
            data: databaseData
            ...
            <div className={Styles.innerContainer}>
                <div className={Styles.rightInnercontainerBody}>
                    <div className={Styles.mainMain}>
                        ...
                        <ImageUpload  image={image as string}   uploadToServer={uploadForServer} />
                    </div>
                    <div className={Styles.mainLeft}>
                        <div className={Styles.formHeader}>
                            Forms for this subject.
                        </div>
                            <SelectMiu displayLabel="Select Form" forms={options} handlechange={handleSelect} value={formValue} />
                ...
                <div onClick={handleCreateSubject} className={Styles.imageSelect}>Update Subject</div>
