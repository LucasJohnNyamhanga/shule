  ...
  return (
    <div className={Styles.container}>
      <div className={Styles.innerContainer}>
        ...
        <p>
          Welcome to <strong>datasoft technologies</strong> (&ldquo;we&rdquo;,
        ...
        <p>
          ...
          <strong>shule</strong>
          <strong>.co.tz</strong> (together or individually
        ...
        <p>
          ...
          <strong>info@database.co.tz</strong> so we can try to find a solution.
        ...
        <p>
          ...
          renew under the exact same conditions unless you cancel it or datasoft
          technologies cancels it. You may cancel your Subscription renewal
          either through your online account management page or by contacting:
          info@database.co.tz, or our customer support line +255784477999.
        </p>
        <p>
          A valid payment method is required to process the payment for your
          subscription. You shall provide datasoft technologies with accurate
          and complete billing information that may include but not limited to
          full name, address, postal or zip code, telephone number, and a valid
          payment method information. By submitting such payment information,
          you automatically authorize datasoft technologies to charge all
          Subscription fees incurred through your account to any such payment
          instruments.
        </p>
        <p>
          Should automatic billing fail to occur for any reason, datasoft
          technologies reserves the right to terminate your access to the
        ...
        <p>
          datasoft technologies may, at its sole discretion, offer a
        ...
        <p>
          ...
          Trial, you will not be charged by datasoft technologies until Free
        ...
        <p>
          At any time and without notice, datasoft technologies reserves the
        ...
        <p>
          datasoft technologies, in its sole discretion and at any time, may
        ...
        <p>
          datasoft technologies will provide you with a reasonable prior notice
        ...
        <p>
          We issue refunds for Contracts within <strong>1 days</strong> of the
        ...
        <p>
          ...
          material (&ldquo;Content&rdquo;). You are responsible for Content that
        ...
        <p>
          datasoft technologies has the right but not the obligation to monitor
          and edit all Content provided by users.
        </p>
        <p>
          In addition, Content found on or through this Service are the property
          of datasoft technologies or used with permission. You may not
        ...
        <p>
          ...
          property of datasoft technologies and its licensors.
        </p>
        <ol start={15}>
          <li>
        ...
        <p>
          Unless otherwise stated in these Terms, or in writing by us, we (or
          our licensors/contractors) own the copyright, trademarks and all other
          intellectual property rights in any materials on Shule.
        </p>
        <p>
          When you put any materials on Shule, you accept that: we may choose to
          monitor what you put on Shule; you keep all rights you have in those
          materials;
        </p>
        <p>
          you may not submit anything owned by someone else, unless they have
          given you permission first; if we think it's right to do so, we may
          remove your materials, or to refuse to make them available; you grant
          us an irrevocable, unlimited, non-exclusive, royalty-free, worldwide
          license to use your materials, or create work based on them, in
          whatever way we wish; you irrevocably and unconditionally waive the
          benefit of any provision of law known as moral rights of authors, or
          any similar law in any country, forever, in respect of that material.
        </p>
        <p>And you confirm that:</p>
        <p>You have the right to put those materials on Shule</p>
        <p>And you may not:</p>
        <p>
          Reproduce, or make available to others, Shule's content; modify or
          create derivative works from Shule's content for commercial
          purposes... or help anyone else to do any of these things, unless you
          already have written permission from Shule.
        </p>
        <ol start={16}>
          <li>
        ...
        <p>
          You may provide us either directly at info@database.co.tz or via third
          ...
          matters related to our Service (&ldquo;Feedback&rdquo;). You
        ...
        <p>
          ...
          that are not owned or controlled by datasoft technologies.
        </p>
        <p>
          datasoft technologies has no control over, and assumes no
        ...
        <p>
          THESE SERVICES ARE PROVIDED BY US ON AN &ldquo;AS IS&rdquo; AND
          &ldquo;AS AVAILABLE&rdquo; BASIS. WE MAKES NO REPRESENTATIONS OR
        ...
        <p>
          ...
          email: <strong>info@database.co.tz</strong> or our help line
          0784477999.
        </p>
      </div>
    </div>
