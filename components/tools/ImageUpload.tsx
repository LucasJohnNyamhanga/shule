...
export default function PrivatePage({uploadToServer, deactiveteImage, image , clear, clearData }:dataType) {
  const [display, setDisplay] = useState(false);
  const [createObjectURL, setCreateObjectURL] = useState< string | null| undefined >(null);
  ...
  return (
    <div className={Styles.container}>
      <div>
        ...
        />
        <div  onClick={() => fileSelector.current.click()} className={Styles.imageSelect}>
